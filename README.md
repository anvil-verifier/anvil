# Reproducing the Evaluation Results for "Compositional Verification of Cluster Control Planes"

This document describes how to reproduce the results in the Evaluation section of the Welder paper.
...
We requires a Linux X86-64 machine to reproduce the result. You can use a Cloudlab machine (see 2.1). Two repositories are involved:
...
## 1. Reproducing the verification results (~10 mins)
...
### 1.1 Collecting the lines-of-code statistics (<1 min)
