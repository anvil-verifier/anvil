...
| vdeployment_controller::…::liveness::resource_match::lemma_from_old_vrs_len_zero_at_scale_down_old_vrs_to_current_state_matches | 0 (extract `_inductive_step`) | rlimit 64.48M → 41.46M (parent 2.77M + inductive 38.69M) | **−36%** rlimit |
| rabbitmq_controller::…::liveness::resource_match::lemma_from_after_create_resource_step_to_after_get_next_resource_step | 0 (extract `_inductive_step`) | rlimit 43.14M → 31.31M (parent 3.34M + inductive 27.97M) | **−27%** rlimit |
| vreplicaset_controller::…::guarantee::guarantee_condition_holds | 3 (lift quantifier + lemma_guarantee_from_reconcile_state, mirrors vstatefulset) | rlimit 56.46M → 5.25M (guarantee 4.77M + lemma 0.48M) | **−91%** rlimit |
