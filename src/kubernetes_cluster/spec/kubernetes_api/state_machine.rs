...
pub open spec fn state_validity_check(obj: DynamicObjectView) -> bool {
    &&& obj.kind == ConfigMapView::kind() ==> ConfigMapView::state_validation(ConfigMapView::unmarshal(obj).get_Ok_0())
    &&& obj.kind == DaemonSetView::kind() ==> DaemonSetView::state_validation(DaemonSetView::unmarshal(obj).get_Ok_0())
    &&& obj.kind == PersistentVolumeClaimView::kind() ==> PersistentVolumeClaimView::state_validation(PersistentVolumeClaimView::unmarshal(obj).get_Ok_0())
    &&& obj.kind == PodView::kind() ==> PodView::state_validation(PodView::unmarshal(obj).get_Ok_0())
    &&& obj.kind == RoleBindingView::kind() ==> RoleBindingView::state_validation(RoleBindingView::unmarshal(obj).get_Ok_0())
    &&& obj.kind == RoleView::kind() ==> RoleView::state_validation(RoleView::unmarshal(obj).get_Ok_0())
    &&& obj.kind == SecretView::kind() ==> SecretView::state_validation(SecretView::unmarshal(obj).get_Ok_0())
    &&& obj.kind == ServiceView::kind() ==> ServiceView::state_validation(ServiceView::unmarshal(obj).get_Ok_0())
    &&& obj.kind == StatefulSetView::kind() ==> StatefulSetView::state_validation(StatefulSetView::unmarshal(obj).get_Ok_0())
    &&& obj.kind == ServiceAccountView::kind() ==> ServiceAccountView::state_validation(ServiceAccountView::unmarshal(obj).get_Ok_0())
    &&& obj.kind == K::kind() ==> K::state_validation(K::unmarshal(obj).get_Ok_0())
}

pub open spec fn transition_validity_check(obj: DynamicObjectView, old_obj: DynamicObjectView) -> bool {
    &&& obj.kind == ConfigMapView::kind() ==> ConfigMapView::transition_validation(ConfigMapView::unmarshal(obj).get_Ok_0(), ConfigMapView::unmarshal(old_obj).get_Ok_0())
    &&& obj.kind == DaemonSetView::kind() ==> DaemonSetView::transition_validation(DaemonSetView::unmarshal(obj).get_Ok_0(), DaemonSetView::unmarshal(old_obj).get_Ok_0())
    &&& obj.kind == PersistentVolumeClaimView::kind() ==> PersistentVolumeClaimView::transition_validation(PersistentVolumeClaimView::unmarshal(obj).get_Ok_0(), PersistentVolumeClaimView::unmarshal(old_obj).get_Ok_0())
    &&& obj.kind == PodView::kind() ==> PodView::transition_validation(PodView::unmarshal(obj).get_Ok_0(), PodView::unmarshal(old_obj).get_Ok_0())
    &&& obj.kind == RoleBindingView::kind() ==> RoleBindingView::transition_validation(RoleBindingView::unmarshal(obj).get_Ok_0(), RoleBindingView::unmarshal(old_obj).get_Ok_0())
    &&& obj.kind == RoleView::kind() ==> RoleView::transition_validation(RoleView::unmarshal(obj).get_Ok_0(), RoleView::unmarshal(old_obj).get_Ok_0())
    &&& obj.kind == SecretView::kind() ==> SecretView::transition_validation(SecretView::unmarshal(obj).get_Ok_0(), SecretView::unmarshal(old_obj).get_Ok_0())
    &&& obj.kind == ServiceView::kind() ==> ServiceView::transition_validation(ServiceView::unmarshal(obj).get_Ok_0(), ServiceView::unmarshal(old_obj).get_Ok_0())
    &&& obj.kind == StatefulSetView::kind() ==> StatefulSetView::transition_validation(StatefulSetView::unmarshal(obj).get_Ok_0(), StatefulSetView::unmarshal(old_obj).get_Ok_0())
    &&& obj.kind == ServiceAccountView::kind() ==> ServiceAccountView::transition_validation(ServiceAccountView::unmarshal(obj).get_Ok_0(), ServiceAccountView::unmarshal(old_obj).get_Ok_0())
    &&& obj.kind == K::kind() ==> K::transition_validation(K::unmarshal(obj).get_Ok_0(), K::unmarshal(old_obj).get_Ok_0())
}
