...
pub open spec fn the_object_in_schedule_has_spec_as(cr: K) -> StatePred<State<K, E, R>> {
...
pub open spec fn the_object_in_reconcile_has_spec_as(cr: K) -> StatePred<State<K, E, R>> {
