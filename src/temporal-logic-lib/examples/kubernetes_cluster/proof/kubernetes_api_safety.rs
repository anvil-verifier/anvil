...
use crate::common::*;
use crate::examples::kubernetes_cluster::spec::{common::*, distributed_system::*};
...
pub proof fn lemma_always_res_exists_implies_added_event_sent(res: ResourceObj)
    ensures
        sm_spec().entails(
            always(
...
pub proof fn lemma_always_req_not_sent_implies_resp_not_sent(req_msg: Message, resp_msg: Message)
    requires
