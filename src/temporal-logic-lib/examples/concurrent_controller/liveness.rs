    ...
    ensures
        sm_spec()
            .entails(lift_state(init())
                .leads_to(lift_state(|s| resource_exists(s, cr_name + sts_suffix() + pod_suffix())))),
{
    ...
    use_tla_forall::<CState, Message>(sm_spec(), |msg| weak_fairness(k8s_handle_create(msg)), create_sts_req_msg(cr_name + sts_suffix()));
    use_tla_forall::<CState, Message>(sm_spec(), |msg| weak_fairness(k8s_handle_create(msg)), create_pod_req_msg(cr_name + sts_suffix() + pod_suffix()));
    ...
    k8s_handle_create_enabled(create_sts_req_msg(cr_name + sts_suffix()));
    wf1::<CState>(sm_spec(),
        next(),
        k8s_handle_create(create_sts_req_msg(cr_name + sts_suffix())),
        k8s_handle_create_pre(create_sts_req_msg(cr_name + sts_suffix())),
        |s| message_sent(s, create_pod_req_msg(cr_name + sts_suffix() + pod_suffix()))
    );
    ...
    k8s_handle_create_enabled(create_pod_req_msg(cr_name + sts_suffix() + pod_suffix()));
    wf1::<CState>(sm_spec(),
        next(),
        k8s_handle_create(create_pod_req_msg(cr_name + sts_suffix() + pod_suffix())),
        k8s_handle_create_pre(create_pod_req_msg(cr_name + sts_suffix() + pod_suffix())),
...
proof fn lemma_init_leads_to_vol_exists(cr_name: Seq<char>)
    ensures
        sm_spec()
            .entails(lift_state(init())
                .leads_to(lift_state(|s| resource_exists(s, cr_name + vol_suffix())))),
{
    leads_to_eq_auto::<CState>(sm_spec());
    ...
    use_tla_forall::<CState, Message>(sm_spec(), |msg| weak_fairness(k8s_handle_create(msg)), create_cr_req_msg(cr_name));
    use_tla_forall::<CState, Message>(sm_spec(), |msg| weak_fairness(k8s_handle_create(msg)), create_vol_req_msg(cr_name + vol_suffix()));
    ...
    k8s_handle_create_enabled(create_vol_req_msg(cr_name + vol_suffix()));
    wf1::<CState>(sm_spec(),
        next(),
        k8s_handle_create(create_vol_req_msg(cr_name + vol_suffix())),
        k8s_handle_create_pre(create_vol_req_msg(cr_name + vol_suffix())),
