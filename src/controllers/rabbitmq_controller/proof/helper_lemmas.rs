...
ensures
    ...
    s.resources().contains_key(get_request(rabbitmq, sub_resource).key) == s_prime.resources().contains_key(get_request(rabbitmq, sub_resource).key),
    s.resources()[get_request(rabbitmq, sub_resource).key] == s_prime.resources()[get_request(rabbitmq, sub_resource).key],
{}
