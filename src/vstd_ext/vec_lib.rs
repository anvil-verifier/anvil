...
// macro_rules! make_vec_filter {
//     ($name:ident, $T:ty, $spec:ident) => {
//         verus! {
//         pub fn $name(
//             v: &Vec<$T>,
//             f: impl Fn(&$T) -> bool,
...
//             forall |v: $T, r: bool| f.ensures((&v,), r) ==> $spec(v.deep_view()) == r,
//         ensures
//             r.deep_view() =~= v.deep_view().filter($spec)
//         {
//             let mut r = Vec::new();
//             let mut i = 0;

//             let ghost f_spec = |v: $T| $spec(v);
...
//                     lemma_filter_push(
//                         v.deep_view().take(i as int),
//                         f_spec,
//                         elem_spec
//                     );

//                     assert(
//                         v.deep_view().take(i + 1 as int)
//                         ==
//                         v.deep_view().take(i as int).push(elem_spec)
//                     );
//                 }
//             }
...
//     make_vec_filter!(filter_positive, i32, |x: i32| is_positive(x));
// }
