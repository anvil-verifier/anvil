...
#[verifier(external_body)]
pub proof fn int_to_string_view_injectivity_for(i: int, j: int)
    requires
        int_to_string_view(i) == int_to_string_view(j)
    ensures
        i == j,
{}

#[verifier(external_body)]
pub proof fn int_to_string_view_ensures_for(n: int)
    ensures
...
#[verifier(external_body)]
pub proof fn bool_to_string_view_ensures_for(i: bool)
    ensures
        bool_to_string_view(i) == new_strlit("true")@ || bool_to_string_view(i) == new_strlit("false")@,
{}
