...
impl Container {
    ...
    pub fn set_image(&mut self, image: String)
        ensures final(self)@ == old(self)@.with_image(image@),
    {
    ...
    pub fn set_volume_mounts(&mut self, volume_mounts: Vec<VolumeMount>)
        ensures final(self)@ == old(self)@.with_volume_mounts(volume_mounts.deep_view()),
    {
    ...
    pub fn set_ports(&mut self, ports: Vec<ContainerPort>)
        ensures final(self)@ == old(self)@.with_ports(ports.deep_view()),
    {
    ...
    pub fn set_lifecycle(&mut self, lifecycle: Lifecycle)
        ensures final(self)@ == old(self)@.with_lifecycle(lifecycle@),
    {
    ...
    pub fn set_resources(&mut self, resources: ResourceRequirements)
        ensures final(self)@ == old(self)@.with_resources(resources@),
    {
    ...
    pub fn set_liveness_probe(&mut self, liveness_probe: Probe)
        ensures final(self)@ == old(self)@.with_liveness_probe(liveness_probe@),
    {
    ...
    pub fn set_readiness_probe(&mut self, readiness_probe: Probe)
        ensures final(self)@ == old(self)@.with_readiness_probe(readiness_probe@),
    {
    ...
    pub fn set_command(&mut self, command: Vec<String>)
        ensures final(self)@ == old(self)@.with_command(command.deep_view()),
    {
    ...
    pub fn set_image_pull_policy(&mut self, image_pull_policy: String)
        ensures final(self)@ == old(self)@.with_image_pull_policy(image_pull_policy@),
    {
    ...
    pub fn set_env(&mut self, env: Vec<EnvVar>)
        ensures final(self)@ == old(self)@.with_env(env.deep_view()),
    {
    ...
    pub fn set_args(&mut self, args: Vec<String>)
        ensures final(self)@ == old(self)@.with_args(args.deep_view()),
    {
    ...
    pub fn set_security_context(&mut self, security_context: SecurityContext)
        ensures final(self)@ == old(self)@.with_security_context(security_context@),
    {
...
impl ContainerPort {
    ...
    pub fn set_container_port(&mut self, container_port: i32)
        ensures final(self)@ == old(self)@.with_container_port(container_port as int),
    {
...
impl VolumeMount {
    ...
    pub fn set_mount_path(&mut self, mount_path: String)
        ensures final(self)@ == old(self)@.with_mount_path(mount_path@),
    {
    ...
    pub fn set_read_only(&mut self, read_only: bool)
        ensures final(self)@ == old(self)@.with_read_only(read_only),
    {
    ...
    pub fn set_sub_path(&mut self, sub_path: String)
        ensures final(self)@ == old(self)@.with_sub_path(sub_path@),
    {
    ...
    pub fn set_mount_propagation(&mut self, mount_propagation: String)
        ensures final(self)@ == old(self)@.with_mount_propagation(mount_propagation@),
    {
...
impl Probe {
    ...
    pub fn set_exec(&mut self, exec: ExecAction)
        ensures final(self)@ == old(self)@.with_exec(exec@),
    {
    ...
    pub fn set_failure_threshold(&mut self, failure_threshold: i32)
        ensures final(self)@ == old(self)@.with_failure_threshold(failure_threshold as int),
    {
    ...
    pub fn set_initial_delay_seconds(&mut self, initial_delay_seconds: i32)
        ensures final(self)@ == old(self)@.with_initial_delay_seconds(initial_delay_seconds as int),
    {
    ...
    pub fn set_period_seconds(&mut self, period_seconds: i32)
        ensures final(self)@ == old(self)@.with_period_seconds(period_seconds as int),
    {
    ...
    pub fn set_success_threshold(&mut self, success_threshold: i32)
        ensures final(self)@ == old(self)@.with_success_threshold(success_threshold as int),
    {
    ...
    pub fn set_tcp_socket(&mut self, tcp_socket: TCPSocketAction)
        ensures final(self)@ == old(self)@.with_tcp_socket(tcp_socket@),
    {
    ...
    pub fn set_timeout_seconds(&mut self, timeout_seconds: i32)
        ensures final(self)@ == old(self)@.with_timeout_seconds(timeout_seconds as int),
    {
...
impl TCPSocketAction {
    ...
    pub fn set_host(&mut self, host: String)
        ensures final(self)@ == old(self)@.with_host(host@),
    {
    ...
    pub fn set_port(&mut self, port: i32)
        ensures final(self)@ == old(self)@.with_port(port as int),
    {
...
impl Lifecycle {
    ...
    pub fn set_pre_stop(&mut self, handler: LifecycleHandler)
        ensures final(self)@ == old(self)@.with_pre_stop(handler@),
    {
...
impl EnvVar {
    ...
    pub fn set_value(&mut self, value: String)
        ensures final(self)@ == old(self)@.with_value(value@),
    {
    ...
    pub fn set_value_from(&mut self, value_from: EnvVarSource)
        ensures final(self)@ == old(self)@.with_value_from(value_from@),
    {
...
impl EnvVarSource {
    ...
    pub fn set_field_ref(&mut self, field_ref: ObjectFieldSelector)
        ensures final(self)@ == old(self)@.with_field_ref(field_ref@),
    {
