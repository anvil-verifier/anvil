...
// Update requests to pods carry a resource version on them (despite 
// the underlying kind permitting unconditional updates), and other 
// controllers don't try to update pods owned by a VReplicaSet.
