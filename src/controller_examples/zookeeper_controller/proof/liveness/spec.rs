...
pub open spec fn derived_invariants_since_beginning(zookeeper: ZookeeperClusterView) -> TempPred<ZKCluster> {
    ...
    .and(always(lift_state(ZKCluster::the_object_in_reconcile_satisfies_state_validation(zookeeper.object_ref()))))
        ...
        cluster_spec().entails(derived_invariants_since_beginning(zookeeper)),
{
    ...
    ZKCluster::lemma_always_the_object_in_reconcile_satisfies_state_validation(spec, zookeeper.object_ref());
