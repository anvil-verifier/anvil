...
pub proof fn reconcile_eventually_terminates(spec: TempPred<FBCCluster>, fbc: FluentBitConfigView)
    requires
        ...
        spec.entails(always(lift_state(FBCCluster::no_pending_req_msg_or_external_api_input_at_reconcile_state(
            fbc.object_ref(), |s: FluentBitConfigReconcileState| s.reconcile_step == FluentBitConfigReconcileStep::Init)))),
