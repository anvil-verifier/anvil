        ...
        valid(stable(sm_partial_spec(simple_reconciler()).and(all_invariants(cr)))),
{
    ...
    always_p_stable::<State<SimpleReconcileState>>(lift_state(every_in_flight_req_has_unique_id::<SimpleReconcileState>()));
        ...
        ),
{
    ...
    strengthen_next_3::<State<SimpleReconcileState>>(partial_spec_with_invariants_and_assumptions(cr), next(simple_reconciler()), crash_disabled::<SimpleReconcileState>(), |s: State<SimpleReconcileState>| {s.resource_obj_exists(cr.to_dynamic_object())}, every_in_flight_req_has_unique_id::<SimpleReconcileState>(), stronger_next);
