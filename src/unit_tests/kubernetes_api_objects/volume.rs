...
pub fn test_set_host_path() {
    ...
    assert_eq!(
        ...
        volume.into_kube().host_path.unwrap()
    );
}
...
pub fn test_set_config_map() {
    ...
    assert_eq!(
        ...
        volume.into_kube().config_map.unwrap()
    );
}
...
pub fn test_set_projected() {
    ...
    assert_eq!(
        ...
        volume.into_kube().projected.unwrap()
    );
}
...
pub fn test_set_secret() {
    ...
    assert_eq!(
        ...
        volume.into_kube().secret.unwrap()
    );
}
...
pub fn test_set_downward_api() {
    ...
    assert_eq!(
        ...
        volume.into_kube().downward_api.unwrap()
    );
}
...
pub fn test_set_empty_dir() {
    ...
    assert_eq!(
        ...
        volume.into_kube().empty_dir.unwrap()
    );
}
...
pub fn test_kube() {
    ...
    assert_eq!(volume.into_kube(), kube_volume);
}
