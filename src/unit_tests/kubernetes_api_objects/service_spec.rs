...
pub fn test_set_cluster_ip() {
    ...
    assert_eq!(
        "ip".to_string(),
        service_spec.into_kube().cluster_ip.unwrap()
    );
}
...
pub fn test_set_selector() {
    ...
    assert_eq!(
        selector.into_rust_map(),
        service_spec.into_kube().selector.unwrap()
    );
}
...
pub fn test_selector() {
    ...
    assert_eq!(
        selector.into_rust_map(),
        service_spec.selector().unwrap().into_rust_map()
    );
}
...
pub fn test_clone() {
    ...
    assert_eq!(service_spec.into_kube(), cloned_service_spec.into_kube());
}
...
pub fn test_kube() {
    ...
    assert_eq!(service_spec.into_kube(), kube_service_spec);
}
