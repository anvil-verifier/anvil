...
pub fn test_set_spec() {
    ...
    assert_eq!(
        ...
        stateful_set.into_kube().spec.unwrap()
    );
}
...
pub fn test_spec() {
    ...
    assert_eq!(
        stateful_set_spec.into_kube(),
        stateful_set.spec().unwrap().into_kube()
    );
}
...
pub fn test_clone() {
    ...
    assert_eq!(stateful_set.into_kube(), cloned_stateful_set.into_kube());
}
...
pub fn test_status() {
    ...
    assert_eq!(
        ...
        stateful_set.status().unwrap().into_kube()
    );
}
...
pub fn test_kube() {
    ...
    assert_eq!(stateful_set.into_kube(), kube_stateful_set);
}
