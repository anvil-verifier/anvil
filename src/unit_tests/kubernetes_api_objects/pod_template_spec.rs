...
pub fn test_set_metadata() {
    ...
    assert_eq!(
        ...
        pod_template_spec.into_kube().metadata.unwrap()
    );
}
...
pub fn test_set_spec() {
    ...
    assert_eq!(
        pod_spec.into_kube(),
        pod_template_spec.into_kube().spec.unwrap()
    );
}
...
pub fn test_clone() {
    ...
    assert_eq!(
        pod_template_spec.into_kube(),
        pod_template_spec_clone.into_kube()
    );
}
...
pub fn test_kube() {
    ...
    assert_eq!(pod_template_spec.into_kube(), kube_pod_template_spec);
}
