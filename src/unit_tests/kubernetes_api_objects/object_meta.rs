...
pub fn test_set_namespace() {
    ...
    assert_eq!(
        "namespace".to_string(),
        object_meta.into_kube().namespace.unwrap()
    );
}
...
pub fn test_set_labels() {
    ...
    assert_eq!(
        labels.into_rust_map(),
        object_meta.into_kube().labels.unwrap()
    );
}
...
pub fn test_labels() {
    ...
    assert_eq!(
        labels.into_rust_map(),
        object_meta.labels().unwrap().into_rust_map()
    );
}
...
pub fn test_resource_version() {
    ...
    assert_eq!(
        ...
        object_meta.resource_version().unwrap()
    );
}
...
pub fn test_set_annotations() {
    ...
    assert_eq!(
        annotations.into_rust_map(),
        object_meta.into_kube().annotations.unwrap()
    );
}
...
pub fn test_set_finalizers() {
    ...
    assert_eq!(
        finalizers_gen(),
        object_meta.into_kube().finalizers.unwrap()
    );
}
...
pub fn test_clone() {
    ...
    assert_eq!(object_meta.into_kube(), object_meta_clone.into_kube());
}
...
pub fn test_set_owner_references() {
    ...
    assert_eq!(
        own_refs_gen()
            .into_iter()
            .map(|s: OwnerReference| s.into_kube())
            .collect::<Vec<_>>(),
        object_meta.into_kube().owner_references.unwrap()
    );
}
...
pub fn test_kube() {
    ...
    assert_eq!(object_meta.into_kube(), kube_object_meta);
}
