...
pub fn test_set_selector() {
    ...
    assert_eq!(
        ...
        daemon_set_spec.into_kube().selector
    );
}
...
pub fn test_set_template() {
    ...
    assert_eq!(
        ...
        daemon_set_spec.into_kube().template
    );
}
...
pub fn test_selector() {
    ...
    assert_eq!(
        label_selector.into_kube(),
        daemon_set_spec.selector().into_kube()
    );
}
...
pub fn test_template() {
    ...
    assert_eq!(
        pod_template_spec.into_kube(),
        daemon_set_spec.template().into_kube()
    );
}
...
pub fn test_clone() {
    ...
    assert_eq!(
        ...
        daemon_set_spec_clone.into_kube()
    );
}
...
pub fn test_kube() {
    ...
    assert_eq!(daemon_set_spec.into_kube(), kube_daemon_set_spec);
}
