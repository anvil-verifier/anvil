...
pub fn test_set_api_groups() {
    ...
    let api_groups_gen = || {
        let api_groups_1 = "api_groups1".to_string();
        let api_groups_2 = "api_groups2".to_string();
...
pub fn test_set_resources() {
    let mut policy_rule = PolicyRule::default();
    let resources_gen = || {
        let resources_1 = "resources1".to_string();
        let resources_2 = "resources2".to_string();
...
pub fn test_set_verbs() {
    let mut policy_rule = PolicyRule::default();
    let verbs_gen = || {
        let verbs_1 = "verbs1".to_string();
        let verbs_2 = "verbs2".to_string();
