...
// In the reference fluent-operator, there are multiple reconcile loops for managing fluent-bit.
...
pub async fn fluent_bit_reconcile(
    fb_from_cache: Arc<FluentBit>,
    ctx: Arc<Data>,
) -> Result<Action, Error> {
    info!("FluentBit reconciler running...");
...
pub fn fluent_bit_error_policy(_object: Arc<FluentBit>, error: &Error, _ctx: Arc<Data>) -> Action {
